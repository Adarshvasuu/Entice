...
export const BlogsPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute top-0 left-0 w-full h-full min-h-[2200px] pointer-events-none z-[-2]"
        style={{
      ...
      <div className="relative z-10">
        ...
        <section className="relative pt-[85px] pb-16 md:pb-20 px-4 sm:px-8 max-w-7xl mx-auto text-center overflow-hidden">
          ...
          <motion.p 
            ...
            className="relative text-lg text-white/75 max-w-2xl mx-auto mt-4 leading-relaxed"
          >
